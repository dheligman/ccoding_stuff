...
/*When implemementing a function that takes a SimpleString as an argument, it will invoke the copy constructor that is defined in the SimpleString class. 
This it will not affect the buffer formed by the original SimpleString a.*/